...
\pgfplotstableread[col sep=comma]{data/Tag_ranking.csv}{\ranktable}
\pgfplotstablegetcolsof{\ranktable}
 ...
 \centering
   \begin{tikzpicture}
     \begin{axis}[
       ...
       xtick=data,
       ybar=0pt,
       xticklabels from table={\ranktable}{Rank},
...
%\begin{figure}[H]
%\centering
%\includegraphics[width=\linewidth]{figs/sca_12.png}
%\caption{Az eredeti hálózat -- az összes olyan játék alapján, amikor 1-nél több játékos vett részt a kihívásban}
%\label{fig:original}
%\end{figure}

%\begin{figure}[H]
%\centering
%\includegraphics[width=\linewidth]{figs/sca_22.png}
%\caption{A módosított hálózat -- az egyes játékokban legtöbbször elért csúcsok kerültek törlésre}
%\label{fig:mody}
%\end{figure}

%Számok, adatok: 5481 törölt csúcs, 15345 játék
